    ...
    <TouchableOpacity style={styles.card} activeOpacity={0.9} onPress={() => navigation.navigate('CreateShoppingList', { selectedStore: store } as any)}>
      <View style={styles.media}>
        {store.image ? (
          ...
          <LinearGradient colors={['#00D4AA', '#00B894']} style={styles.image}>
      ...
      <View style={styles.body}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.sep}>•</Text>
          <Text style={styles.meta}>{store.distance} km</Text>
        </View>
        <View style={styles.rowBetween}>
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity onPress={() => navigation.goBack()} style={styles.back}><Ionicons name="chevron-back" size={22} color="#111827" /></TouchableOpacity>
      ...
      <View style={styles.searchBar}>
        ...
        <TextInput
          ...
          onChangeText={setQ}
        />
        <TouchableOpacity><Ionicons name="filter" size={18} color="#00D4AA" /></TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  chipActive: { backgroundColor: '#00D4AA20', borderColor: '#00B89455' },
  chipText: { color: Colors.textPrimary, fontSize: 13, fontFamily: 'Poppins-Medium' },
  ...
  media: { height: 140, backgroundColor: Colors.gray300 },
  image: { width: '100%', height: '100%', justifyContent: 'center', alignItems: 'center' },
  body: { padding: 12 },
  row: { flexDirection: 'row', alignItems: 'center' },
  rowBetween: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  name: { fontSize: 18, fontWeight: 'bold', color: Colors.textPrimary, fontFamily: 'Poppins-Bold' },
  ...
  meta: { color: '#6B7280' },
  fee: { color: '#6B7280' },
  cta: { backgroundColor: '#00D4AA', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 10 },
